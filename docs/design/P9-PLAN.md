...
- **`[→]` P9c-2 — Picture-in-Picture (native): deferred to `docs/BACKLOG.md`** (revisit P18).
...
- **Cross-platform route transitions** — `pageTransitionsTheme` extended beyond Android to
  windows/linux/macOS/iOS (`FadeForwardsPageTransitionsBuilder`); future-proofs Windows (P17).
